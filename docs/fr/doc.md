# DAW PHP Validator - Documentation Française
...
| ------- | -------------- | ----------- |
| static void | extend(string $ruleName, callable $condition, string $errorMessage) | Pour ajouter une règle dee validation |
